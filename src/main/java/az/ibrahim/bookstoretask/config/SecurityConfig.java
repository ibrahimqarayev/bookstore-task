    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/authors/{authorId}/books").permitAll()
                        .requestMatchers("/api/v1/authors/publish-book").hasAuthority("AUTHOR")
                        ...
                        .requestMatchers("/api/v1/students/{bookId}/read-book").hasRole("STUDENT")
